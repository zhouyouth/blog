    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>上传附件限制</label><span><?php echo get_cfg_var('upload_max_filesize')?get_cfg_var('upload_max_filesize'):'服务器不允许上传附件';?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>QQ：</label><span><a href="#">394167573</a></span><label>QQ：</label><span><a href="#">394167573</a></span><label>QQ：</label><span><a href="#">394167573</a></span>
                </li>
                <li>
                    <?php /*<label>官方交流QQ群：</label><span><a href="#"><img border="0" src="http://pub.idqqimg.com/wpa/images/"></a></span>*/ ?>
                </li>
            </ul>
        </div>
    </div>
