...
<article class="blogs">
  <h1 class="t_nav"><span>您当前的位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="/news/s/">{{$field->cate_name}}</a>&nbsp;&gt;&nbsp;<a href="{{url('/a').'/'.$field->art_id}}">{{$field->art_tag}}</a></span><a href="/" class="n1">网站首页</a><a href="{{url('/cat'). $field->cate_id}}" class="n2">{{$field->cate_name}}</a></h1>
  <div class="index_about">
    ...
    <ul class="infos">
      ...
      <p><img src="{{asset('/resources/views/home/style/images/e5e39b1148811261c78b933805d07232.png')}}" alt="分手"></p>
      ...
      <p><img src="{{asset('/resources/views/home/style/images/1f8aea2172f6eb987c3de3f7ba474eb1.png')}}" alt="分手"></p>
