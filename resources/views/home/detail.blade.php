...
<article class="blogs">
  <h1 class="t_nav"><span>您当前的位置：<a href="/">首页</a>&nbsp;&gt;&nbsp;<a href="/news/s/">{{$field->cate_name}}</a>&nbsp;&gt;&nbsp;<a href="/news/s/">日记</a></span><a href="/" class="n1">网站首页</a><a href="{{url('/cat'). $field->cate_id}}" class="n2">{{$field->cate_name}}</a></h1>
